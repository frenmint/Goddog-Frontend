...
function SwapCard(props: any) {
  ...
  return (
    <Card className="bg-cardBg mx-auto p-3 h-[399px]  text-text border-lightSoft font-bold ">
      <CardContent className="mt-4">
        ...
        <div className="">
          <div className="border p-5 rounded-lg  border-soft mt-1.5 h-[100px]">
            <div className="flex justify-between  w-full">
              <div className=" ">
                <div className="">
                  <h3 className="text-lightSoft text-[12px]">You pay</h3>
                </div>
                <div className="">
                  <input
                    placeholder="0"
                    className="bg-transparent  w-[90%] text-start focus:outline-none text-[25px]"
              ...
              <div className=" grid grid-rows-2">
                <PairsDialog
                  trigger={
                    <Button className="bg-soft w-[105px] rounded-lg p-1.5 mt-3">
          ...
          <div>
            <div className="border p-5 rounded-lg  border-soft mt-1.5 h-[100px]">
              <div className="flex justify-between  w-full">
                <div className=" ">
                  <div className="">
                    <h3 className="text-lightSoft text-[12px]">You receive</h3>
                  </div>
                  <div className="">
                    <input
                      placeholder="0"
                      className="bg-transparent  w-[90%] text-[25px] text-start focus:outline-none"
                      disabled={true}
